...
class LabeledTransitionSystemImpl implements LabeledTransitionSystem {
	...
	@Override
	public LabeledTransitionSystemEvent next(LabeledTransitionSystemState state, LabelTransitionSystem symptom) {
	...
	private boolean evaluate(BooleanExpression expression, LabelTransitionSystem symptom) {
	...
	private boolean transition(LabeledTransitionSystemState state, LabelTransitionSystem symptom) {
